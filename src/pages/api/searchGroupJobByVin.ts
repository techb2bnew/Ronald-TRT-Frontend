// pages/api/searchGroupJobByVin.ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    let backendUrl = `${apiBaseUrl}/searchGroupJobByVin?searchQuery=${encodeURIComponent(searchQuery)}&roleType=${encodeURIComponent(roleType)}`;
    ...
    console.error('Error in searchGroupJobByVin API:', error);
