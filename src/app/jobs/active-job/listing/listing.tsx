...
const TechnicianTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-4">
      <CommonHeader heading='Active Jobs' title="Onboard clients effortlessly for seamless collaboration!" onSearch={handleSearch} buttonLabel="Create job" buttonLink="/" />
