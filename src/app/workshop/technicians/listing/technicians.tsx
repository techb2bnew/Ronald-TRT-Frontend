...
const TechnicianTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-4">
      <CommonHeader heading='IFS Technicians' title="Onboard clients effortlessly for seamless collaboration!" onSearch={handleSearch} buttonLabel="Create Technician" buttonLink="/workshop/technicians/create-technician"/>
          ...
          <tbody>
            ...
            {technicians.map((tech, index) => (
              <tr key={index}>
                ...
                <td>
                <TableActions 
                editRoute="/workshop/technicians/create-technician"
              />
                </td>
              </tr>
            ))}
