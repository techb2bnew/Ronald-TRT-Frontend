      ...
      <div className='bg-white p-4 mt-5 w-[60%] m-auto'>
        <form className="">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className='mb-2'>
              <label htmlFor="" className='text-sm'>Client Name</label>
              <input
                type="text"
            ...
            <div className='mb-2'>
              <label htmlFor="" className='text-sm'>Business Name</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2  items-start mb-2">
            <div className='mb-2 me-2'>
              <label htmlFor="" className='text-sm'>Enter your phone number</label>
              <input
                type="number"
            ...
            <div className='mb-2 me-2'>
              <label htmlFor="" className='text-sm'>Secondary Contact Name</label>
            ...
            <div className='mb-2 me-2'>
              <label htmlFor="" className='text-sm'>Tax Forms</label>
              ...
              <div className="form-control w-full p-3 mt-1 rounded relative" style={{border:'2px dashed #ccc'}}>
                ...
                <input type="file" className="input input-bordered w-full opacity-0 absolute inset-0" />
              </div>
            </div>
            <div className='mb-2 ms-2'>
              <label htmlFor="" className='text-sm'>Pay Rate</label>

              <select defaultValue="" className="select input text-xs mt-1 input-bordered w-full p-3 rounded border border-gray-400">
          ...
          <div className="mb-4">
          <label htmlFor="" className='text-sm'>Amount/Percentage</label>
          <input
            type="text"
            placeholder="$50/$20%"
            className="input text-xs mt-1 input-bordered w-full p-3 rounded border border-gray-400"
