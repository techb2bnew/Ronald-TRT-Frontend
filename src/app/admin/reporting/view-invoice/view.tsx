                    ...
                    ? vehicle.assignedTechnicians.map((tech: any, index: number) => (
                      <tr key={`${vehicle.id}-${tech.id}-${index}`} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-6 py-4 text-right">
                          <Link href={`/admin/technicians/view?technicianId=${tech.id}`} className="inline-flex items-center justify-center w-9 h-9 rounded-full  transition-colors" data-tooltip-id="view-tech" data-tooltip-content="View">
                ...
                {Array.isArray(jobData?.job?.vehicles) && jobData.job.vehicles.length > 0 ? (
                  jobData.job.vehicles.map((vehicles: any, index: number) => (
                    <tr key={vehicles.id ?? index} className="hover:bg-gray-50/50">
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link href={`/admin/vehicle/view?vehicleId=${vehicles.id}`} className="inline-flex items-center justify-center w-9 h-9 rounded-full  transition-colors" data-tooltip-id="view-vehicle" data-tooltip-content="View">
                          <Image alt="View" src={Eye} className="w-4 h-4" />
                        </Link>
                      </td>
                    </tr>
