...
export default function ViewDetails() {
  ...
  const fetchCustomerData = async (vehicleId: string) => {
    try {
      ...
      const response = await fetch(`${BASE_PATH}/api/fetchSingleVehicleInfo?vehicleId=${vehicleId}`, {
        method: 'GET',
        headers,
      });
          ...
          <div className="view_inner_content grid grid-cols-2 gap-3 p-6">
            ...
            <div className='shadow-lg p-5 bg-white rounded'>
              ...
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                ...
                {jobData?.vin || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Vehicle Descriptor:</strong>
                {jobData?.vehicleDescriptor || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Make:</strong>
                {jobData?.make || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Model:</strong>
                {jobData?.model || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Model Year:</strong>
                {jobData?.modelYear || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Manufacturer Name:</strong>
                {jobData?.manufacturerName || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Vehicle Type:</strong>
                {jobData?.vehicleType || <span className="text-gray-500">No data available</span>}
              </p>
            </div>
            ...
            <div className='shadow-lg p-5 bg-white rounded'>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                ...
                {jobData?.bodyClass || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Color:</strong>
                {jobData?.color || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Plant Country:</strong>
                {jobData?.plantCountry || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Plant Company:</strong>
                {jobData?.plantCompanyName || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Plant State:</strong>
                {jobData?.plantState || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Created By:</strong>
                {jobData?.createdBy || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
                <strong className='w-[210px] inline-block'>Customer:</strong>
                {jobData?.customer?.fullName || <span className="text-gray-500">No data available</span>}
              </p>
              <p className='mb-4 border-b border-gray-500 text-sm mb-3 pb-4'>
