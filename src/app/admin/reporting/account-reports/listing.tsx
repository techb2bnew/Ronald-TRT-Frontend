  ...
  const renderRow = (job: any) => {
    ...
    return (
      <tr key={job.id}>
        ...
        <td><Link href={`/admin/reporting/account-view?jobId=${job.id}`} className='hover:underline'>  {job?.customer?.fullName} </Link></td>
        ...
        <td className='text-left'>
          <Link href={`/admin/reporting/account-view?jobId=${job.id}`} >
