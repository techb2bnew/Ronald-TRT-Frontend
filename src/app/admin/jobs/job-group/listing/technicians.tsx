...
function JobTListing() {
      ...
      <tr key={job.uniqueKey}>
        ...
        <td>
          <div className="flex items-center gap-3">
            <Link href={`/admin/jobs/job-group/view?vin=${job.vin}&customerId=${job.assignCustomer}&jobId=${job.jobId}`}>
  ...
  return (
    <div className={`mobile_listing mx-auto mt-4 transition-all duration-300 ${isCollapsed ? 'w-full pl-[5rem]' : 'container'}`}>
      <Breadcrumb
        items={[{ label: 'Group Work Orders', href: '/admin/jobs/job-group/listing' }]}
      />
      <CommonHeader
        heading=""
