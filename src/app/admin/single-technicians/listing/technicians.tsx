  ...
  const renderRow = (tech: any, index?: number) => {
    ...
    return (
      <tr key={tech.id}>
        ...
        <td>{serialNo}</td>
        {/* <td> <Link href={`/admin/single-technicians/view?technicianId=${tech.id}`} className='hover:underline'>{tech.id}</Link></td> */}
        ...
        <td>
          <div className="flex items-center gap-2">
            ...
            <span><Link href={`/admin/single-technicians/view?technicianId=${tech.id}`} className='hover:underline capitalize'>{tech?.firstName} {tech?.lastName}</Link> </span>
          </div>
        </td>
        ...
        <td className="w-[110px] whitespace-nowrap">
          <TableActions
            ...
            viewRoute={`/admin/single-technicians/view?technicianId=${tech.id}`}
