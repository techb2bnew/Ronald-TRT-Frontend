...
const TechnicianTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-4">
      <CommonHeader heading='IFS Technicians' onSearch={handleSearch} buttonLabel="Create Technician" userRole='Customer' buttonLink="/admin/workshop/technicians/create-technician"/>
          ...
          <tbody>
            ...
            {technicians.map((tech, index) => (
              <tr key={index}>
                ...
                <td>
                {/* <TableActions 
                editRoute="/admin/workshop/technicians/create-technician"
              /> */}
                </td>
              </tr>
            ))}
