...
const TechnicianTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-4">
      <CommonHeader heading='IFS Admin' onSearch={handleSearch} userRole='Customer' buttonLabel="Create IFS Admin" buttonLink="/admin/workshop/admin/create" />
            ...
            {technicians.map((tech, index) => (
              <tr key={index}>
                ...
                <td>
                  ...
                  {/* <TableActions editRoute="/admin/workshop/clients/create"   
