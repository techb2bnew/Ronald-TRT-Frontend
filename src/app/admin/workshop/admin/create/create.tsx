...
export default function Technicians() {
  ...
  return (
    <div className='main-container mb-5'>
      <h1 className="text-lg leading-6 font-bold text-gray-900 mb-[2px] sm:mb-0">Create IFS Admin</h1>
      ...
      <div className='bg-white p-4 mt-5 w-[60%] m-auto'>
        <form className="">
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Client Name and Business Name */}
            <div className='mb-2'>
              <label htmlFor="" className='text-sm'>Secondary Phone Number (Optional)</label>
              <input
                type="number"
            ...
            <div className='mb-2'>
              <label htmlFor="" className='text-sm'>Secondary Email (Optional)</label>
              <input
                type="email"
          ...
          <div className="grid grid-cols-2  items-start mb-2">
            ...
            <div className='mb-2 me-2'>
              <label htmlFor="" className='text-sm'>Tax Forms <span className='text-[red]'>*</span></label>
          ...
          <p className='mb-3 text-sm'><b>Role:</b> IFS Admin</p>
