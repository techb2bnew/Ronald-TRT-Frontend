                ...
                <section className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/customer/listing" className="flex items-center text-sm text-purple-600 hover:text-purple-800 transition-colors cursor-pointer">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/jobs/active-job" className="flex items-center text-sm text-emerald-600 hover:text-emerald-800 transition-colors cursor-pointer">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/technicians/listing" className="flex items-center text-sm text-rose-600 hover:text-rose-800 transition-colors cursor-pointer">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/vehicle/listing" className="flex items-center text-sm text-blue-600 hover:text-blue-800 transition-colors cursor-pointer">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/manager/listing" className="flex items-center text-sm text-amber-600 hover:text-amber-800 transition-colors cursor-pointer">
                ...
                <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/single-technicians/listing" className="flex items-center text-sm text-teal-600 hover:text-teal-800 transition-colors cursor-pointer">
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            {/* <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/single-technician/customer" className="flex items-center text-sm text-orange-600 hover:text-orange-800 transition-colors cursor-pointer">
                                    <span className="font-medium">View details</span>
                                    <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/single-technicians/all-jobs" className="flex items-center text-sm text-pink-600 hover:text-pink-800 transition-colors cursor-pointer">
                                    <span className="font-medium">View details</span>
                                    <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                    ...
                    <div className="group relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <Link href="/admin/single-technicians/vehicle-info" className="flex items-center text-sm text-indigo-600 hover:text-indigo-800 transition-colors cursor-pointer">
                                    <span className="font-medium">View details</span>
                                    <svg className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                    </svg>
                                    ...
                                    {sortedJobs.map((job) => (
                                        <tr key={job.id} className="hover:bg-gray-50 transition-colors">
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <Link href={`/admin/jobs/view?jobId=${job.id}&ActiveWorkOrder`} className="text-blue-600 hover:underline">
                                                    {job.id}
                                                </Link>
                                            </td>
