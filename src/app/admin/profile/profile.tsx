...
import { useTechnician } from "@/app/admin/techheaderprofile/headerprofile";
...
export default function ProfileCard() {
  ...
  const fetchTechnicianData = async (technicianId: string) => {
    try {
      ...
      const response = await fetch(`${BASE_PATH}/api/fetchTechnicianProfile`, {
  ...
  const handleProfileUpdate = async () => {
    ...
    try {
      const response = await fetch(`${BASE_PATH}/api/updateTechnicianProfile`, {
        method: "POST",
        headers: {
