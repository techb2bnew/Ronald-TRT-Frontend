  ...
  const renderRow = (tech: any) => (
    <tr key={tech.id}>
      ...
      <td className='font-sm'>
        <Link href={`/admin/jobs/create-job/create?jobId=${tech.id}`} className='flex gap-2 items-center border border-black rounded p-2 pl-4 pr-4 w-[135px] justify-center'>Create Job
      ...
      <td>
        <TableActions
          editRoute={`/admin/technicians/create-technician?technicianId=${tech.id}`}
          viewRoute={`/admin/technicians/view?technicianId=${tech.id}`}
