...
const TechnicianTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-4">
      <CommonHeader heading='IFS Admin' title="Onboard clients effortlessly for seamless collaboration!" onSearch={handleSearch} buttonLabel="Create IFS Admin" buttonLink="/admin/create" />
