...
export default function ViewDetails() {
  ...
  return (
    <>
      ...
      className="w-[100px] h-[100px] rounded shadow-lg cursor-pointer"
    />
    ) : (
        ...
        <div className="bg-blue rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-2 gap-6 p-6">
            ...
            <div className='shadow-lg p-5 bg-white rounded'> 
              <p className='mb-2 border-b border-gray-500 mb-3 pb-2'><strong className='w-[200px] inline-block'>Secondary Ph:</strong> {technician?.secondaryContactName}</p>
