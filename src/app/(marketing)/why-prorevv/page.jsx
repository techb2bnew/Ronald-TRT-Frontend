...
import Advantage from "../../Components/Pagecomponents/Advantage";
...
const page = () => {
  return (
    <div>
      <BannerCenter
        top_bar={"Why Prorevv"}
        title={"Why Repair Professionals Choose Prorevv"}
        description={
          "Because generic software wasn’t built for hail repair — Prorevv was."
        }
        btn_name={"Get a Demo"}
