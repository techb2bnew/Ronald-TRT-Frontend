...
import ProblemSolver from '../../Components/Pagecomponents/ProblemSolver'
import WhyProrevv from '../../Components/Pagecomponents/WhyProrevv'
import ProfessionalsBuilt from '../../Components/Pagecomponents/ProfessionalsBuilt'
...
import CoreValues from '../../Components/Pagecomponents/CoreValues'
...
const page = () => {
  return (
    <div>
      <BannerCenter
        top_bar={'About Us'}
        title={'Built by Repair Professionals. Designed for Performance.'}
        description={'Prorevv was created to eliminate chaos in hail repair businesses — replacing spreadsheets, manual tracking, and missed payments with one powerful system.'}
        btn_name={'Get a Demo'}
