          ...
          <div className="md:w-1/2" style={{ padding: '0px 5rem' }}>
            ...
            <form className="mt-3" action="#" method="POST">
              <div className="mb-3">
                ...
                <input type="text" name="" id="" placeholder="Full Name" className="w-full px-4 py-2 rounded-lg bg-white mt-2 border border-gray-400 focus:border-black-500 focus:bg-white focus:outline-none" autoFocus required />
              </div>

              <div className="mb-3">
                <label className="block text-[#161616]">Phone Number</label>
                <input type="number" name="" id="" placeholder="Enter your Phone Number" className="w-full px-4 py-2 rounded-lg bg-white mt-2 border border-gray-400 focus:border-black-500 focus:bg-white focus:outline-none" autoFocus required />
              </div>

              <div className="mb-3">
                <label className="block text-[#161616]">Email Address</label>
                <input type="email" name="" id="" placeholder="Enter your email address" className="w-full px-4 py-2 rounded-lg bg-white mt-2 border border-gray-400 focus:border-black-500 focus:bg-white focus:outline-none" autoFocus required />
              </div>

              <div className="mt-3 relative">
                <label className="block text-[#161616]">Password</label>
                <input type="password" name="" id="" placeholder="Enter your Password" className="w-full px-4 py-2 rounded-lg bg-white mt-2 border border-gray-400 focus:border-black-500
                  focus:bg-white focus:outline-none" required />
                  <Link href='#' style={{position: 'absolute', right: '10px', top: '44px'}}>
              ...
              <div className="flex justify-between items-center mt-3">
                <div className="inline-flex items-center">
                  <label className="flex items-center cursor-pointer relative">
                    <input type="checkbox" className="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow bg-white hover:shadow-md border border-slate-300 checked:bg-[#EF502E] checked:border-[#EF502E]" id="check" />
