        ...
        {recordType !== "Job" && (
          <div className="grid grid-cols-2 gap-6 p-6">
            ...
            <div className='shadow-lg p-5 bg-white rounded'>
              ...
              <div className='mb-2 border-b border-gray-500 mb-3 pb-2 flex items-center'><strong className='w-[200px] inline-block'>Technician Name:</strong> 
              ...
              <div className='mb-2 border-b border-gray-500 mb-3 pb-2'>
